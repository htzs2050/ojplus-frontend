                    ...
                    <el-col style="display: flex" :span="9">
                        <el-col :span="12" style="flex: 1" class="button-container">
                            <el-button type="default"
                                >Upload<el-icon :size="30" color="blue" class="el-icon--right">
                                    <User />
                                </el-icon>
                            </el-button>
                            <el-button type="default">
                                Upload<el-icon :size="30" color="red" class="el-icon--right">
                                    <Connection />
                                </el-icon>
                            </el-button>
                        </el-col>
                        <el-col :span="12" style="flex: 1" class="button-container">
                            <el-button type="default">
                                Upload<el-icon :size="30" color="green" class="el-icon--right">
                                    <QuestionFilled />
                                </el-icon>
                            </el-button>
                            <el-button type="default">
                                Upload<el-icon :size="30" color="orange" class="el-icon--right">
                                    <Promotion />
                                </el-icon>
                            </el-button>
                        </el-col>
                      ...
                      <div v-loading="loading">
                        <el-tabs v-model="activeTab" type="border-card" @tab-click="handleTabClick" >
                            ...
                            <el-tab-pane label="Config" name="config">
                              <div v-loading="loading" element-loading-background="white">
